                        ...
                        <div class="bg-white mt-1 grid-col-template2 ps-3 align-items-center cart-item">
                            <div class="d-flex align-items-center">
                                <div class="me-2" style="display: contents;">
                                    <p class="text-black"><?= $invoice['invoice_id'] ?? '' ?></p>
                                </div>
                            </div>
                            <div>
                                <p class="text-black" style="display: contents;"><?= $invoice['shipment_method'] ?? '' ?></p>
                            </div>
                            <div>
                                <p class="text-black" style="display: contents;"><?= $invoice['payment_method'] ?? '' ?></p>
                            </div>
                            <div>
                                <p class="text-black" style="display: contents;"><strong><?= $invoice['total'] ?? 0 ?><sup>đ</sup></strong></p>
                            </div>
                            <div>
                                <p class="text-black" style="display: contents;"><?= $invoice['created_at'] ?? '' ?></p>
                            </div>
                            <div class="d-flex align-items-center">
                            ...
                            <div class="p-2 d-flex flex-column">
                                ...
                                <form action="/invoice/delete" method="post">
                                    ...
                                    <button type="submit" class="btn btn-danger " name="destroy-invoice" id="<?= $invoice['invoice_id'] ?? '' ?>_destroy">Hủy đơn hàng</button>
                                </form>
                            </div>
                        </div>
                    </div>
